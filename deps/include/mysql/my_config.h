...
#define DEFAULT_MYSQL_HOME "/opt/local/mysql"
#define SHAREDIR "/opt/local/mysql/share"
#define DEFAULT_BASEDIR "/opt/local/mysql"
#define MYSQL_DATADIR "/usr/local/mysql/data"
#define MYSQL_KEYRINGDIR "/usr/local/mysql/keyring"
#define DEFAULT_CHARSET_HOME "/opt/local/mysql"
#define PLUGINDIR "/opt/local/mysql/lib/plugin"
