...
class CEvtrctNetDispatch : public std::enable_shared_from_this<CEvtrctNetDispatch>
{
public:
...
public:
        CEvtrctNetDispatch(const CEvtrctNetDispatch&) = delete;
        CEvtrctNetDispatch& operator=(const CEvtrctNetDispatch&) = delete;
        CEvtrctNetDispatch();
        ~CEvtrctNetDispatch();
};
